...
/**
 * Модификация программы для просмотра изображений.
 * В программе предусмотрена регистрация событий.
...
class ImageViewerFrame extends JFrame
{
    ...
    private class FileOpenListener implements ActionListener
    {
        public void actionPerformed(ActionEvent event)
        {
            ...
            // Принимать файлы с расширением .gif
            ...
            // Если файл выбран, устанавливается пиктограмма
...
/**
 * Обработчик для вывода в окне регистрационных записей.
 */
