...
public class CallerMediator
{
        ...
        {   // Проход по тех. процессам
            ...
            try
            {
                ...
                {   // Проход по операциям тех. процесса
                    ...
                    double normType = currentOperation.getNormTime() == null
                    	? 0.0
                    	: currentOperation.getNormTime();
    ...
    {
        int affected = 0;
        String qDelOperations = String.format("DELETE FROM xxodi.xxtu_operations WHERE process_id = ?");
