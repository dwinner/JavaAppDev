...
public class ID3v2TagFactory
{
    ...
    private static AbstractID3v2Tag createID3v22Tag(byte[] bytes) throws NoSuchTagException,
                                                                         UnsupportedTagException,
                                                                         InvalidDataException
    {
                                                           ...
                                                           UnsupportedTagException
    {
        ...
        if (!AbstractID3v2Tag.TAG.equals(BufferTools.byteBufferToStringIgnoringEncodingIssues(bytes,
                                                                                              0,
