...
public class MenuDemo implements ActionListener
{
    ...
    public MenuDemo()
    {
        ...
        makeActions();
        // Создание действий для управления меню и панелью инструментов View.
        makeViewsActions();
    ...
    /**
     * Класс действий для меню View и одноименных кнопок в панели инструментов
     */
    private class ViewAction extends AbstractAction
    {
        ...
        /**
         * Обработка событий, связанных с панелью инструментов для View и меню Debug.
         * <p/>
         * @param ae
         */
        @Override
    ...
    /**
     * Формирование действий для меню View и панели инструментов для View.
     */
