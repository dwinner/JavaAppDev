...
import static pkg04.treeanimationtest.RandomUtil.*;
...
public class Branch extends Group
{
    ...
    public final SimpleDoubleProperty globalAngle = new SimpleDoubleProperty(90);
    public double globalH; // used for change color of top leaves
    ...
    public Branch()
    { //default constructor for root branch
        base = new Line();
    ...
    public Branch(Branch parentBranch, Type type, int depth)
    {
        ...
        globalH = getTranslateY() *
           cos(PI / 2 - parentBranch.globalAngle.get() * PI / 180) + 
           parentBranch.globalH;
