...
/**
Фрейм, в котором для размещения компонентов
используется диспетчер компоновки SpringLayout.
 */
class FontDialogFrame extends JFrame
{
    ...
    FontDialogFrame()
    {
        ...
        // Добавление пружин для размещения компонентов.
        Spring strut = Spring.constant(10);

        Spring labelsEast = Spring.sum(
            strut,
            Spring.max(
        ...
        Spring secondRowNorth = Spring.sum(
            strut,
            Spring.max(
        ...
        Spring thirdRowNorth = Spring.sum(
            s,
            Spring.max(
        ...
        Spring secondColumnWest = Spring.sum(
            strut,
            Spring.max(
    ...
    /**
    Обработчик, изменяющий шрифт, которым отображается строка-образец.
     */
