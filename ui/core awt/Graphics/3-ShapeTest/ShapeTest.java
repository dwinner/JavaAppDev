...
/**
 * Эта программа демонстрирует примеры рисования различных двухмерных фигур.
 * <p/>
...
/**
 * Фрейм с раскрывающимся списком для выбора фигуры и компонентом для ее рисования.
 */
...
/**
 * Компонент, отвечающий за рисование фигуры и позволяющий пользователю перемещать определяющие ее
 * точки.
 */
class ShapeComponent extends JComponent
{
    ...
    /**
     * Установка объекта, поддерживающего фигуру, и инициализация его набором точек с произвольными
     * координатами.
     * <p/>
...
abstract class ShapeMaker
{
     ...
     * <p/>
     * @param aPointCount Количество точек, необходимых для определения данной фигуры.
     */
    ...
    /**
     * Данный метод возвращает количество точек, необходимых для определения фигуры.
     * <p/>
...
/**
 * Создание дуги, ограничивающий прямоугольник которой строится на основании двух угловых точек.
 * Начальный угол и угол дуги задаются с помощью прямых, проведенных через центр ограничивающего
 * прямоугольника и соответствующую контрольную точку. Для демонстрации процесса построения дуги
 * отображаются ограничивающий прямоугольник и линии, определяющие углы.
 */
