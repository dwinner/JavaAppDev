...
public class WebSplitPaneUI extends BasicSplitPaneUI
{
    ...
    public BasicSplitPaneDivider createDefaultDivider ()
    {
        return new BasicSplitPaneDivider ( this )
        {
            ...
            {
                WebButton iconWebButton = WebButton.createIconWebButton ( new ImageIcon (
                        WebSplitPaneUI.class.getResource (
                                orientation == JSplitPane.HORIZONTAL_SPLIT ? "icons/left.png" :
                                        "icons/up.png" ) ), 0, 0, 0, false, true, false );
                iconWebButton.setBorder ( BorderFactory.createEmptyBorder ( 0, 0, 0, 0 ) );
                iconWebButton.setCursor ( Cursor.getDefaultCursor () );
                iconWebButton.setPreferredSize (
                        orientation == JSplitPane.HORIZONTAL_SPLIT ? new Dimension ( 6, 7 ) :
                                new Dimension ( 7, 6 ) );
            ...
            {
                JButton iconWebButton = WebButton.createIconWebButton ( new ImageIcon (
                        WebSplitPaneUI.class.getResource (
                                orientation == JSplitPane.HORIZONTAL_SPLIT ? "icons/right.png" :
                                        "icons/down.png" ) ), 0, 0, 0, false, true, false );
                iconWebButton.setBorder ( BorderFactory.createEmptyBorder ( 0, 0, 0, 0 ) );
                iconWebButton.setCursor ( Cursor.getDefaultCursor () );
                iconWebButton.setPreferredSize (
                        orientation == JSplitPane.HORIZONTAL_SPLIT ? new Dimension ( 6, 7 ) :
            ...
            public void paint ( Graphics g )
            {
                ...
                if ( orientation == JSplitPane.HORIZONTAL_SPLIT )
                {
                    ...
                    g2d.setPaint ( new LinearGradientPaint ( 0, startY, 0, endY,
                            new float[]{ 0f, 0.25f, 0.75f, 1f }, gradient ) );
                ...
                else
                {
                    ...
                    g2d.setPaint ( new LinearGradientPaint ( startX, 0, endX, 0,
                            new float[]{ 0f, 0.25f, 0.75f, 1f }, gradient ) );
