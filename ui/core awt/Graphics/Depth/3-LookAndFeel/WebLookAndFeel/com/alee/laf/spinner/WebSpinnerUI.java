...
public class WebSpinnerUI extends BasicSpinnerUI
{
    private static final ImageIcon UP_ICON =
            new ImageIcon ( WebSpinnerUI.class.getResource ( "icons/up.png" ) );
    private static final ImageIcon DOWN_ICON =
            new ImageIcon ( WebSpinnerUI.class.getResource ( "icons/down.png" ) );
    ...
    private void updateBorder ( boolean drawBorder )
    {
        if ( spinner != null )
        {
            if ( drawBorder )
            {
                spinner.setBorder ( BorderFactory
    ...
    public void paint ( Graphics g, JComponent c )
    {
        ...
        LafUtils.drawWebBorder ( ( Graphics2D ) g, c, StyleConstants.shadeColor, shadeWidth,
                round );

        // Отрисовка фокуса
        LafUtils.drawWebFocus ( ( Graphics2D ) g, c, FocusType.fieldFocus, shadeWidth, round, null,
                SwingUtils.hasFocusOwner ( spinner ) );
    ...
    {
        WebButton nextButton = WebButton.createIconWebButton ( UP_ICON, 2, 1, 2 );
    ...
    {
        WebButton previousButton = WebButton.createIconWebButton ( DOWN_ICON, 2, 1, 2 );
