...
public class VerticalFlowLayout extends FlowLayout
{
    ...
    /**
     * places the components defined by first to last within the target container using the bounds
     * box defined
     *
     ...
     */
    private void placethem ( Container target, int x, int y, int width, int height, int first,
                             int last )
    {
