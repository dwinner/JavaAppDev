...
/**
 * Программа тестирования свойств. Запоминает размер, положение окна фрейма
 * и его заголовок.
...
/**
 * Фрейм, восстанавливающий положение и размер из файла свойств,
 * и обновляющий его при выходе.
 */
class PropertiesFrame extends JFrame
{
    ...
    {
        // Получить позицию, размер и заголовок из свойств.
        ...
        // Если заголовка нет, запросить пользователя.
