 ...
 * which diabled text is painted.  As VerticalLabelUI does not override the method
 * paintDisabledText, this class can be adapted for Metal L&F by extending MetalLabelUI instead of
 * BasicLabelUI.
 * <p/>
...
public class VerticalLabelUI extends BasicLabelUI
{
     ...
     * method and copies them after they have been altered by {@link SwingUtilities#layoutCompoundLabel(FontMetrics,
     * String, Icon, int, int, int, int, Rectangle, Rectangle, Rectangle, int)}
     */
    @Override
                                ...
                                Rectangle viewR, Rectangle iconR, Rectangle textR )
    {
        ...
        text = super.layoutCL ( label, fontMetrics, text, icon, verticalViewR, verticalIconR,
                verticalTextR );
