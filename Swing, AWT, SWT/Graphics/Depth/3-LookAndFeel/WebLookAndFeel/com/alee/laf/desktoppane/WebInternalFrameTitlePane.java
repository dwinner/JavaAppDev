...
{
    public static final ImageIcon iconifyIcon =
            new ImageIcon ( WebInternalFrameTitlePane.class.getResource ( "icons/minimize.png" ) );
    public static final ImageIcon maximizeIcon =
            new ImageIcon ( WebInternalFrameTitlePane.class.getResource ( "icons/maximize.png" ) );
    public static final ImageIcon restoreIcon =
            new ImageIcon ( WebInternalFrameTitlePane.class.getResource ( "icons/restore.png" ) );
    public static final ImageIcon closeIcon =
            new ImageIcon ( WebInternalFrameTitlePane.class.getResource ( "icons/close.png" ) );
    ...
    public WebInternalFrameTitlePane ( JInternalFrame f )
    {
        ...
        setBorder ( BorderFactory
                .createEmptyBorder ( StyleConstants.shadeWidth, StyleConstants.shadeWidth,
                        StyleConstants.shadeWidth, StyleConstants.shadeWidth ) );
    ...
    public void paintComponent ( Graphics g )
    {
        ...
        if ( !isFrameTitle () )
        {
            LafUtils.drawWebBorder ( ( Graphics2D ) g, WebInternalFrameTitlePane.this,
                    StyleConstants.shadeColor, StyleConstants.shadeWidth, StyleConstants.round,
                    true, false );
        }
    }
    ...
    protected void setButtonIcons ()
    {
        ...
        maxButton.setIcon ( frame.isMaximum () ? restoreIcon : maximizeIcon );
