...
package com.alee.examples.helpers;
...
public class ObjectMoveAdapter extends MouseAdapter
{
    ...
    public void mouseDragged ( MouseEvent e )
    {
        if ( dragging )
        {
            e.getComponent ().setBounds (
                    new Rectangle ( startBounds.x + e.getLocationOnScreen ().x - startPoint.x,
                            startBounds.y + e.getLocationOnScreen ().y - startPoint.y,
    ...
    public void mouseReleased ( MouseEvent e )
    {
        if ( SwingUtilities.isLeftMouseButton ( e ) && dragging )
        {
            ...
            //            bounds.x = ( bounds.x / 25 ) * 25 + ( bounds.x % 25 > 13 ? 25 : 0 );
            //            bounds.y = ( bounds.y / 25 ) * 25 + ( bounds.y % 25 > 13 ? 25 : 0 );
            //            e.getComponent ().setBounds ( bounds );
