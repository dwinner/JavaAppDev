...
public class RunPattern
{
   public static void main(String[] arguments)
   {
      ...
      System.out.println(" to extend the basic functionality of ProjectItems. The decorator.Task and");
      System.out.println(" decorator.Deliverable classes provide the basic ProjectItems, and their");
      System.out.println(" functionality will be extended by adding subclasses of the");
      System.out.println(" abstract class decorator.ProjectDecorator.");
      System.out.println();
      ...
      Contact contact1 = new ContactImpl("Simone", "Roberto", "Head Researcher and Chief Archivist",
      ...
      Deliverable deliverable1 = new Deliverable("Java History", "Comprehensive history of the design of all Java APIs",
                                                 contact1);
      System.out.println("decorator.ProjectItem objects created. Results:");
