...
int main()
{
   ...
   class_ImageViewer = (*env)->FindClass(env, "ImageViewer");
   id_main = (*env)->GetStaticMethodID(env, class_ImageViewer, "main", "([Ljava/lang/String;)V");

   class_String = (*env)->FindClass(env, "java/lang/String");
   args = (*env)->NewObjectArray(env, 0, class_String, NULL);
   (*env)->CallStaticVoidMethod(env, class_ImageViewer, id_main, args);
