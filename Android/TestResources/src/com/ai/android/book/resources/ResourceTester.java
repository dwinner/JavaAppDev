...
{
   private static String tag = ResourceTester.class.getName();
   ...
   {
      mReportTo.reportBack(tag, this.mContext.getString(stringid));
   }
   ...
   public void testXML()
   {
      try
      {
         String x = getEventsFromAnXMLFile(mContext);
         reportString(x);
      }
      catch (Throwable t)
      {
   ...
   private String getEventsFromAnXMLFile(Context activity) throws XmlPullParserException,
         IOException
   {
   ...
   public void testRawFile()
   {
      try
      {
         String s = getStringFromRawFile(mContext);
         reportString(s);
      }
      catch (Throwable t)
      {
   ...
   public void testAssets()
   {
      try
      {
         String s = getStringFromAssetFile(mContext);
         reportString(s);
      }
      catch (Throwable t)
      {
