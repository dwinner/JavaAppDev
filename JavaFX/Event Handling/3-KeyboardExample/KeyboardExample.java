...
/**
 * Обработчики событий (распространение вверх).
 *
 * @author oracle_pr1
 */
public final class KeyboardExample extends Application
{
    ...
    private static final class Key
    {
        ...
        {
            // Обработчик для событий нажатия/отпускания клавиши Enter,
            // другие клавиши обрабатываются триггером родительского узла            
    ...
    private static final class Keyboard
    {
        ...
        {
            // Обработчик для событий нажатия/отпускания клавиш
            // с дальнейшим НЕраспространением "вверх"
            final EventHandler<KeyEvent> keyEventHandler = new EventHandler<KeyEvent>()
            {
                @Override
                public void handle(final KeyEvent keyEvent)
