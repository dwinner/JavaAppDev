...
public class FxSeparatorTest extends Application
{
    private Label caption = new Label("Weather Forecast");
    private Label friday = new Label("Friday");
    private Label saturday = new Label("Saturday");
    private Label sunday = new Label("Sunday");
    ...
    public void start(Stage primaryStage)
    {
        ...
        primaryStage.setTitle("Separator Sample");
        ...
        scene.setRoot(grid);
        scene.getStylesheets().add("pkg16/fxseparatortest/separatorsample/controlStyle.css");
        
        Image cloudImage = new Image(getClass().getResourceAsStream("cloud.jpeg"));
        Image sunImage = new Image(getClass().getResourceAsStream("sun.jpeg"));
