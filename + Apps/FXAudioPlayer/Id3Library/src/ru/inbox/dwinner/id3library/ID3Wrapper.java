...
public class ID3Wrapper
{
   ...
   {
      if (id3v2Tag != null && id3v2Tag.getTrack() != null && !id3v2Tag.getTrack().trim().isEmpty())
      {
   ...
   {
      if (id3v2Tag != null && id3v2Tag.getArtist() != null && !id3v2Tag.getArtist().trim().isEmpty())
      {
   ...
   {
      if (id3v2Tag != null && id3v2Tag.getTitle() != null && !id3v2Tag.getTitle().trim().isEmpty())
      {
   ...
   {
      if (id3v2Tag != null && id3v2Tag.getAlbum() != null && !id3v2Tag.getAlbum().trim().isEmpty())
      {
   ...
   {
      if (id3v2Tag != null && id3v2Tag.getYear() != null && !id3v2Tag.getYear().trim().isEmpty())
      {
