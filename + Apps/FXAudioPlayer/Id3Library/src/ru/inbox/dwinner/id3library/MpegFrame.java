...
public class MpegFrame
{
   ...
   {
      null, MPEG_LAYER_1, MPEG_LAYER_2, MPEG_LAYER_3
   };
   ...
   public MpegFrame(byte[] frameData) throws InvalidDataException
   {
      ...
      long frameHeader = BufferTools.unpackInteger(frameData[0], frameData[1], frameData[2],
                                                   frameData[3]);
      setFields(frameHeader);
   }

   public MpegFrame(byte frameData1, byte frameData2, byte frameData3, byte frameData4) throws
