...
public final class EncodedText
{
    ...
    {
        for (byte _textEncoding : textEncodingFallback)
        {
            this.textEncoding = _textEncoding;
            value = stringToBytes(string, characterSetForTextEncoding(_textEncoding));
    ...
    public EncodedText(String string, byte transcodeToTextEncoding) throws IllegalArgumentException,
    ...
    public void setTextEncoding(byte textEncoding, boolean transcode) throws
       CharacterCodingException
    {
        if (this.textEncoding != textEncoding)
        {
            CharBuffer charBuffer = bytesToCharBuffer(this.value, characterSetForTextEncoding(
               this.textEncoding));
    ...
    public int hashCode()
    {
        ...
        hash = 79 * hash + this.textEncoding;
        return hash;
    }

    public static String bytesToString(byte[] bytes, String characterSet) throws
       CharacterCodingException
    {
    ...
    static CharBuffer bytesToCharBuffer(byte[] bytes, String characterSet) throws
       CharacterCodingException
    {
    ...
    static byte[] charBufferToBytes(CharBuffer charBuffer, String characterSet) throws
       CharacterCodingException
    {
        Charset charset = Charset.forName(characterSet);
